...
把圖檔丟進這個資料夾，檔名照下表。`src/data/resumeData.js` 的 `awards`、`outreach`
與 `outdoors` 已經把路徑接好了，檔案放進來就會自動生效 —— 不用改程式。

沒放檔案的項目，點開時會顯示「尚未上傳」，不會出現破圖。

| 檔名 | 對應項目 | 區塊 | 狀態 |
| --- | --- | --- | --- |
| `2026-city-dashboard-hackathon-3rd.jpg` | 雙北程式設計節 CODEFEST — 第三名 | 獎項 | ✅ |
...
| `2023-ncu-swimming-2nd.jpg` | 中央 112 學年度運動大會 50m 仰式 第二名 | 獎項 | ✅ |
| `2023-national-software-design.jpg` | 全國大專電腦軟體設計競賽 佳作（教育部獎狀） | 獎項 | ✅ |
| `2022-ncu-swimming-3rd.jpg` | 中央 111 學年度運動會 50m 仰式 第三名 | 獎項 | ✅ |
| `2021-vex-inspire-award.jpg` | VEX Inspire Award、全國技能挑戰賽 第 9 名 | 獎項 | ✅ ⚠️ 低解析 265px |
| `2025-tmu-biomedical-engineering-silver.jpg` | 北醫全國醫工創意競賽 高中職組 銀牌（指導） | 教學 | ✅ |
| `2024-quanta-cup-coaching.jpg` | 廣達游智盃 — 指導參賽證明（五常國小） | 教學 | ✅ |
| `2023-jingshin-alumni-talk.jpg` | 靜心高中 — 校友生涯分享 感謝狀 | 教學 | ✅ |
| `2021-dabajian-summit.jpg` | 大霸尖山 3,492m 登頂紀念 | 戶外 | ✅ |
| `2020-leave-no-trace-trainer.jpg` | Leave No Trace Trainer 認證 | 戶外 | ✅ |
| `2014-sun-moon-lake-swim.jpg` | 泳渡日月潭 3,300m 完泳證書 | 戶外 | ✅ |
